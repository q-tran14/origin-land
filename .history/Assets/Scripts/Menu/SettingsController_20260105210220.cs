...
public class SettingsController : MonoBehaviour
{
    ...
    void Awake()
    {
        savePath = GamePaths.SettingsPath;
    ...
    void ApplySettings()
    {
        ...
        // Graphics
        QualitySettings.SetQualityLevel(settings.graphics, true);
        graphicsDropdown.SetValueWithoutNotify(settings.graphics);
    ...
    {
        Debug.Log("Graphics index = " + index);
    ...
    {
        Debug.Log("Brightness slider value = " + value);
